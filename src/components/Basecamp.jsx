...
import { LeftElips, RightElips } from "./common/Icon";

const Basecamp = () => {
  return (
    <div className="max-w-1920px] mx-auto relative overflow-hidden">
      <div className="sm:block hidden absolute right-[-5%] top-[33%] pointer-events-none">
        <RightElips />
      </div>
      <div className="sm:block hidden absolute left-[-3.3%] bottom-[3%] pointer-events-none">
        <LeftElips />
      </div>
      <div className="max-w-[1180px] mx-auto px-5 lg:py-24 md:py-20 sm:py-16 py-12 relative">
